...
class Main_window:
    ...
    def __init__(self):
        ...
        clusters_scale = Scale(frame_inputs, label="Select the number of clusters  :", 
                            from_=1, to=10, orient=HORIZONTAL, length=170, command = lambda a: self.setClusterNumber(a))
        clusters_scale.pack()
    ...
    def setPathFile(self,label_data_set_path):
            ...
            label_data_set_path = "DATA SET path file: "+self.pathDataSetFile
            
    def setClusterNumber(self,val):
